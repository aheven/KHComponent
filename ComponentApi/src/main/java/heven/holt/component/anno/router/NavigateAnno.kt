 ...
 * 返回值支持以下的类型:
 * 1. void
 * 2. [heven.holt.component.ComponentConstants.NAVIGATOR_CLASS_NAME]
 * 3. [heven.holt.component.ComponentConstants.RXJAVA_COMPLETABLE]
 * 4. [heven.holt.component.ComponentConstants.RXJAVA_SINGLE]
